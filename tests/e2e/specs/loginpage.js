module.exports = {
  "verifying the loginpage": (browser) => {
    browser
      ...
      .assert.elementPresent("div.classification-banner.text-center.white--text.body-lg.d-block")
      .assert.elementPresent("div.mr-3")
      .assert.containsText("div.USWDC-official-banner__text.mr-3", "An official website of the United States government")
      .assert.containsText("span.USWDC-official-banner__link_msg.text-decoration-underline", "Here’s how you know")
