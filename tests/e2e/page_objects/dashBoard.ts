...
const dashBoardPage = {
    ...
    elements: {
        ...
        updateBtn: {
            selector: "a.v-btn.v-btn--is-elevated.v-btn--has-bg.v-btn--router.theme--light.v-size--default.primary"
        },
        nameTab: {
...
interface DashBoardPage extends EnhancedPageObject<typeof dashBoardPage.commands[0], typeof dashBoardPage.elements, {}> { }
