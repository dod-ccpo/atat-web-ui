   ...
   */
   const maxLength = (length: number, message?: string): (v: any) => string | true | undefined=> {
   ...
   * @returns {function(*): (boolean|string)}
   */
     const minLength = (length: number, message?: string): (v: any) => string | true | undefined=> {
       ...
       */
      const required = (message?: string): (v: any) => string | true | undefined => {
