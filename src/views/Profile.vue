    ...
    <v-row>
      <v-col>
        ...
        <p>
          ...
          profile. We will use this information to notify you if there are any
          ...
          <div>
            <v-row>
              <v-col cols="1" class="text-center px-0">
                <v-icon
                  class="ml-6 icon-24 text--base-darkest"
                  aria-hidden="true"
                >
                  info
                </v-icon>
        ...
        <v-card rounded class="mb-6 border-base-lighter border-1" outlined>
          <v-card-title class="h3 pl-8 pt-8">Basic Information</v-card-title>
          <v-card-text
            class="
              body-lg
              pl-8
        ...
        <v-card rounded class="mb-6 border-base-lighter border-1" outlined>
          <v-card-title class="h3 pl-8 pt-8">Contact Information</v-card-title>
          <v-card-text
            class="
              body-lg
              pl-8
