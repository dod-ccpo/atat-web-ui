<template>
  <v-container class="dashboard-body body-lg">
    <v-row>
      <v-col>
        <h2 class="mt-4 h2 font-weight-bold">
    ...
    <v-row>
      <v-col>
        <p class="mb-3">
          ...
          issues with your funding or cloud resources.
        </p>
        <p>
          Please review and verify that the following details are accurate. When
          you are done, click <strong>Continue</strong> and we will get started
        ...
        <div>
          ...
          <v-card class="mb-5">
            <v-card-title class="body-lg font-weight-bold"
          ...
          <v-card>
            ...
            <v-card-text>
              <v-row align="center" class="mx-0">
                ...
                <v-col>
                  <p class="body link-body-sm text-decoration-underline">
                    {{ user.email }}
                  </p>
                </v-col>
              </v-row>
              ...
              <v-row align="center" class="mx-0">
                ...
                <v-col class="d-flex">
                  <p class="body text--primary">{{ user.phone_number }}</p>
                  <p class="body ml-4 text--primary">Office (Primary)</p>
                </v-col>
              </v-row>
            </v-card-text>
          </v-card>
          <v-row>
            <v-col cols="12" class="d-flex mt-8 mb-16">
              <v-btn
                @click="handleBack"
                color="primary"
                outlined
