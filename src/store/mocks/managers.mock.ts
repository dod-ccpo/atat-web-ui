...
export const portfolioManagerPermissions: PortfolioManagerPermissions = {
  ...
  EDIT_PORTFOLIO_POC: {
    ...
    description: "Can update Portfolio settings, add Portfolio Managers and delete this Portfolio",
    description_note: "NOTE: The option to delete this Portfolio will only be available as a draft. A Portfolio cannot be removed from ATAT after it has been provisioned.",
  },
};
