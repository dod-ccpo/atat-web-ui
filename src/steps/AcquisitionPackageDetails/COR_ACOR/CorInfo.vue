<template>
  <v-container fluid class="container-max-width">
    <v-row>
      <v-col>
        <h1 class="page-header" id="CORHeader">Let’s gather info about your Contracting Officer’s
          Representative (COR)
        </h1>
        <p class="body pb-0 mb-0 copy-max-width">Your COR is an important part of your acquisition
