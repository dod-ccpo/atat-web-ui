...
describe("Testing SummaryStepSeven Component", () => {
  ...
  beforeEach(() => {
    vuetify = new Vuetify();
    wrapper = mount(SummaryStepSeven, {
      vuetify,
      localVue
    });
    jest.spyOn(Summary, "validateStepSeven").mockImplementation();
  });

  describe("testing SummaryStepSeven render", () => {
