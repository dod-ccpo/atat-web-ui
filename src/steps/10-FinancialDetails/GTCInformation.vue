        ...
        <v-col class="col-12">
          ...
          <div v-show="useGInvoicing === 'YES'">
            ...
            <ATATSearch
              ...
              :value="gInvoiceNumber"
              @update:value="gInvoiceNumber = $event"
...
<script lang="ts">
import { invalidFile, SaveOnLeaveRefs, uploadingFile, ValidationResult } from "types/Global";
