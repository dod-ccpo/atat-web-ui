  ...
  describe("testing form fields", () => {
    ...
    describe("Validation Tests...", () => {
      ...
      describe("various form controls...", () => {
        ...
        it("testing numberOfInstancesNeeded textbox 'greaterThanOrEqualTo1' rule with VALID data, " +
        "then setting data.errorMessages", async () => {
            computeData.numberOfInstancesNeeded = "1";
            await wrapper.setData({
              _computeData: computeData,
          ...
          it("testing numberOfInstancesNeeded textbox 'greaterThanOrEqualTo1' rule with INVALID data, " +
        "then setting data.errorMessages", async () => {
