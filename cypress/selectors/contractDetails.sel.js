module.exports = {
  ...
  messageNoteSecret: "#MessageNoteSecret",
  messageNoteTopSecret: "#MessageNoteTopSecret",
  messageSecret: "#MessageSecret",
  messageTopSecret: "#MessageTopSecret",
  ...
  cdsLabel2: "#cdsSolutions .text-base",
  cds: "#cdsSolutions",
  ...
  unclastoTopSecrCB: "#Checkbox_UtoTS",
  secrtoUnclasCB: "#Checkbox_StoU",
  secrtoTopSecrCB: "#Checkbox_StoTS",
  tsToUnclass: "#Checkbox_TStoU",
  ...
  cdsStoUTxtbox: "#cdsSolutions #cdsSolutions_TextField2_text_field",
  cdsStoTSTxtbox: "#cdsSolutions #cdsSolutions_TextField3_text_field",
  cdsTStoUTxtbox: "#cdsSolutions #cdsSolutions_TextField4_text_field",
  ...
  projectedFSFieldLabel: "#projectedFileStreamType_text_field_label",
  ...
  anticipatedFieldLabel: "#AnticipatedNeedUsage_01_text_field_label",
  anticipatedFieldLabel2: "#AnticipatedNeedUsage_01_text_field_control .mb-2",
  ...
  basePeriodLabel1:"#EntireDuration_01_radio_group_control legend",
  basePeriodLabel2:"#PeriodsLabel_01",
  basePeriodCheckbox:"#PeriodsCheckboxes_01",
