module.exports = {
  ...
  conusEastCheckbox: "#Checkbox_CONUSEast0",
  conusCentralCheckbox: "#Checkbox_CONUSCentral0",
  conusWestCheckbox: "#Checkbox_CONUSWest0",
  africomCheckbox: "#Checkbox_AFRICOM0",
  centcomCheckbox: "#Checkbox_CENTCOM0",
  eucomCheckbox: "#Checkbox_EUCOM0",
  indopacomCheckbox: "#Checkbox_INDOPACOM0",
  southcomCheckbox: "#Checkbox_SOUTHCOM0",
