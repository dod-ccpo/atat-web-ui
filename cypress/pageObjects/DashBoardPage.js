...
class DashBoardPage {
    ...
    linkOne() {
        return cy.get('div.row.ma-0 span.link-body-md').contains('How will my contact information be used?')
    }
    textUnderLinkOne() {
    ...
    linkTwo() {
        return cy.get('div.row.ma-0.mb-3 span.link-body-md').contains('Why can’t I update my profile in ATAT?')
    }
