...
describe("Test suite: Step02-Evaluation plan", () => {
  ...
  function selectEvalPlanOptionTechProposal(
  ...
  function selectEvalPlanOptionSetLumpSum(
    ...
    if (setLumpSumSelectionMethod === "BestUse") {
      cy.selectCheckBoxes([
        ...
        ep.automationCapabilityCheckBox,
      ]);
    } else {
  ...
  function selectEvalPlanOptionEqualLumpSum() {
    ...
    cy.clickContinueButton(
      ep.equalLumpSum,
      `Based on your evaluation method, there are no required compliance standards,
       differentiators, or assessment areas.`
    );
    cy.clickContinueButton(
  ...
  function evalplanDescriptionDetails() {
    ...
    case "noTechProposal":
      description =
          "Technical proposal not required; award will be made on a LPTA basis.";
      break;
    case "techProposal":
      description =
    ...
    case "setLumpSum":
      description =
          setLumpSumSelectionMethod === "BestUse"
            ...
            " award will be made to the “BEST_USE” solution."
            :"Purchase a set lump sum dollar amount from one CSP;"+
            " award will be made to the “LOWEST_RISK” solution.";
      break;
    case "equalLumpSum":
      description =
          "Purchase an equal set lump sum dollar amount from each CSP.";
      break;
    }
  ...
  it("TC1: Select Eval plan", () => {
    if (evalPlanOption === "techProposal") {
      selectEvalPlanOptionTechProposal(
        setTechProposalSelectionMethod,
        customCompliance,
        customText
      );
