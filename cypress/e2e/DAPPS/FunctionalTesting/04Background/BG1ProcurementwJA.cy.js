...
describe("Test suite: Step04-Procurement History", () => {
  ...
  function verifyEditGatherDetailsForm(contractNo, taskOrderNo, startDateFormatted, 
    expiredDateFormatted, cName) {
    ...
    cy.verifySelectedRadioOption(background.competitionActiveRadio, 
  ...
  it("TC4:Procurement History Summary-Edit contract details", () => {
    ...
    verifyEditGatherDetailsForm(validContractNo, taskOrderNo, startDateFormatted, 
      expiredDateFormatted, cName);
